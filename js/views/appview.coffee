...
define([
  ...
  class AppView extends Backbone.View
    ...
    # If there are currently passwords displayed (unlocked) the app should be 
    # reset, and the focus is set on the input again.
    onClick: =>
      @$weak.blur()
    ...
    # When enter is pressed the weak password should be updated on the server 
    # regardless of the current status of the app. This is a more intuitive 
    # behaviour.
    onKeydown: (e) =>
      if e.which is 13
        @$weak.blur()
