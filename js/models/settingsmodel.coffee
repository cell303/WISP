...
define([
	...
	# This class capsules the settings and saves them to the localStorage if desired.
	class SettingsModel extends Backbone.Model
		...
		# If the store option is set it will also save the settings to the localStorage.
		...
		# @returns {string=} Only if the attributes are not valid. Backbone knows what to do. 
		validate: (attrs) ->
